...
CreateClientConVar("smh_force_render_entities", "1", true, false, "Controls whether all entities are always rendered. This may prevent entities from disappearing between frames", 0, 1)
